...
execute as @s unless entity @s[scores={shearActionsRemaining=0}] if predicate {"condition": "minecraft:random_chance","chance": 0.25} as @p run summon item ~ ~1 ~ {Item:{id:"minecraft:mutton",count:1}}
