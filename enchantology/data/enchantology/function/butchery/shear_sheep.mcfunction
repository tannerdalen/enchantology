...
execute as @s unless entity @s[scores={shearActionsRemaining=0}] if entity @p[predicate=enchantology:probability_25] run summon item ~ ~1 ~ {Item:{id:"minecraft:mutton",count:1}}
