...
scoreboard players set @s isRepulsed 1
...
execute as @e[distance=..5,type=item] run scoreboard players operation @s pos_x -= @n[scores={isRepulsed=1},distance=..5] pos_x
execute as @e[distance=..5,type=item] run scoreboard players operation @s pos_z -= @n[scores={isRepulsed=1},distance=..5] pos_z
...
scoreboard players reset @s isRepulsed